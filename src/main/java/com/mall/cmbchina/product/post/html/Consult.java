...
public class Consult {
    ...
    public StringBuffer getConsultList(String productCode) throws IOException, InterruptedException {
    ...
    public StringBuffer getConsultList(String productCode, String record, String pageSize) throws IOException, InterruptedException {
    ...
    public StringBuffer getConsultList(String productCode, String pageSize) throws IOException, InterruptedException {
        List<NameValuePair> list = new LinkedList<>();
        list.add(new BasicNameValuePair("productCode", productCode));
        list.add(new BasicNameValuePair("pageSize", pageSize));
        UrlEncodedFormEntity entityParam = new UrlEncodedFormEntity(list, "UTF-8");
    ...
    public StringBuffer htmlBuffer(String productCode) throws IOException, InterruptedException {
        StringBuffer buffer = getConsultList(productCode);
        String pageSize = map.get("pageSize");
        String record = map.get("record");

        buffer.append(getConsultList(productCode, record, pageSize));
        buffer.append(getConsultList(productCode, pageSize));
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        System.out.println(consult.htmlBuffer("401345"));
    }
