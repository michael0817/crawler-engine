...
CREATE TABLE `crawler_action_info`  (
  ...
  `action_type` int(11) NULL DEFAULT NULL COMMENT '爬取动作类型(1-点击;2-翻页;3-抓取cookie;4-抓取新闻;5-抓取商品)',
...
) ENGINE = InnoDB AUTO_INCREMENT = 43 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '爬虫执行动作配置表' ROW_FORMAT = Dynamic;
