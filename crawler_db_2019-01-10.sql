...
# Database: crawler_db
# Generation Time: 2019-01-10 15:49:27 +0000
# ************************************************************
...
CREATE TABLE `crawler_milestone` (
  ...
  PRIMARY KEY (`action_id`,`crawler_date`)
