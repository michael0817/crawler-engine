DROP TABLE crawler_action_info;
DROP TABLE crawler_flow_detail;
DROP TABLE crawler_flow_info;
...
INSERT INTO `crawler_action_info` VALUES (28, '招行掌上商城-一级目录', 2, 1, '/_CL5_/Category/GetAllCategories', 'https://ssl.mall.cmbchina.com', '//div[@id=\'divC1Panel\']//li/a/@data-id||//div[@id=\'divC1Panel\']//li/a/text()||//div[@id=\'divC1Panel\']//li/a');
INSERT INTO `crawler_action_info` VALUES (29, '招行掌上商城-二级目录', 2, 1, '/_CL5_/Category/GetCategories?id={5~14}', 'https://ssl.mall.cmbchina.com', '//dl[@class=\'catalog_list\']//dd/a/@c3id||//dl[@class=\'catalog_list\']//dd/a/span/text()||//dl[@class=\'catalog_list\']//dd/a');
...
INSERT INTO `crawler_action_info` VALUES (31, '招行掌上商城-手机目录', 2, 1, '/_CL5_/Product/ProductListAjaxLoad?subCategory=370&navigationKey=&sort=70&pageIndex={1~9}', 'https://ssl.mall.cmbchina.com', '//div[@class=\'item-detail\']//p[@class=\'clearfix\']/span[@class=\'fr grand-total\']/@productid||//div[@class=\'item-detail\']/h4/text()||//div[@class=\'item-detail\']//a/@href');
